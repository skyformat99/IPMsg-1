======================================================================
        IP Messenger for Win 全ソース 取り扱い説明書    2007/08/31
...
・VC++4.1 でコンパイルしています。（VC6 以降でもコンパイル可）
...
・ipmsg.mdp を VC++4.1 で実行します。この中に、IPMSG Release, Debug,
  install, installDbg 版が定義されています。

・最適化はサイズ優先で、例外処理を外しています。

・VC++6.0 以降でもコンパイル可能です。
