...
//@@	virtual int		ExGetRtfText(void *buf,BOOL bRtfFormat=TRUE);
//@@	virtual BOOL	ExSetRtfText(const void *buf,BOOL bRtfFormat=TRUE);
...
public:
	...
	BOOL BallonWindow(LPCSTR msg, LPCSTR title);
...
BOOL GetFileInfomation(const char *path, WIN32_FIND_DATA_U8 *fdata, BOOL need_fname=TRUE);
